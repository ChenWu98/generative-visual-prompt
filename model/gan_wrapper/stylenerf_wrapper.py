...
class StyleNeRFWrapper(torch.nn.Module):
    ...
    def __init__(self, args):
        ...
        self.snckpt = prepare_stylenerf(args)
    ...
    def forward(self, z):
        ...
        relative_range_u_scale = 1.0  # TODO
        relative_range_u = [0.5 - 0.5 * relative_range_u_scale, 0.5 + 0.5 * relative_range_u_scale]
        outputs = self.renderer(
            z=z,
            c=None,
            truncation_psi=1 if self.training else self.args.sample_truncation,
            noise_mode='random',  # TODO: 'const', 'random', 'none'
            render_option=None,
            n_steps=1,  # TODO: num poses?
