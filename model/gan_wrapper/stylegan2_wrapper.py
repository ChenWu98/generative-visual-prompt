...
class StyleGAN2Wrapper(torch.nn.Module):
    ...
    def __init__(self, args):
        ...
        # Set up generator
        self.latent_dim = 512
        self.sg2ckpt, self.img_size, self.channel_multiplier = prepare_stylegan(args)
    ...
    def forward(self, z):
        ...
        img = self.generator([w],
                             ...
                             truncation=1 if self.training else self.args.sample_truncation,
                             truncation_latent=self.mean_latent,
                             randomize_noise=self.args.randomize_noise)[0]
        # Post process.
