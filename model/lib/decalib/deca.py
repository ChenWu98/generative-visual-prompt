...
class DECA(nn.Module):
    ...
    def _setup_renderer(self, model_cfg):
        ...
        self.render = SRenderY(self.image_size, obj_filename=model_cfg.topology_path, uv_size=model_cfg.uv_size, rasterizer_type=self.cfg.rasterizer_type)
        ...
        self.uv_face_mask = F.interpolate(mask, [model_cfg.uv_size, model_cfg.uv_size])
        ...
        self.mean_texture = F.interpolate(mean_texture, [model_cfg.uv_size, model_cfg.uv_size])
    ...
    def _create_model(self, model_cfg):
        ...
        self.D_detail = Generator(latent_dim=self.n_detail+self.n_cond, out_channels=1, out_scale=model_cfg.max_z, sample_mode = 'bilinear')
        # resume model
